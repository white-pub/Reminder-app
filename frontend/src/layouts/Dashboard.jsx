  ...
  colorSchemes: {
    ...
    dark: {
      palette: {
        ...
        background: {
          default: '#0d1117', // Custom background color for dark mode
          paper: '#0d1117', // Custom paper color for dark mode
        },
        text: {
          primary: '#ffffff', // Custom primary text color for dark mode
          secondary: '#b0bec5', // Custom secondary text color for dark mode
        },
      },
    },
  },
